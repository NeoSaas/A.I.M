...
function AdminPanel({setIsAuthenticated, isAuthenticated}) {
    ...
    return (
      <div className='inline-flex w-screen bg-[#FAF9F6] dark:bg-slate-800 text-black dark:text-slate-300'>
        ...
        <div className="w-full inline-block bg-gradient-to-b from-[#FAF9F6] to-slate-500 dark:bg-gradient-to-b dark:from-[#273d4f] dark:to-slate-900 dark:text-white min-h-screen dark:transition-colors dark:duration-300 transition-colors duration-300 ease-in-out dark:ease-in-out">
